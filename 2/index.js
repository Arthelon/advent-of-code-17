...
function getWorriedCheckSum(input) {
  const grid = input
    .split("\n")
    .map(str => str.split("\t").map(num => parseInt(num, 10)));
  let sum = 0;
  for (let row of grid) {
    for (let i = 0; i < row.length; i++) {
      for (let j = i + 1; j < row.length; j++) {
        ...
        if (row[largerIndex] % row[smallerIndex] === 0) {
          console.log(row[largerIndex]);
          console.log(row[smallerIndex]);
          sum += row[largerIndex] / row[smallerIndex];
        }
      }
    }
  }
...
console.log(
  getWorriedCheckSum(`3751	3769	2769	2039	2794	240	3579	1228	4291	220	324	3960	211	1346	237	1586
